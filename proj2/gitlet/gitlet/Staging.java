...
public class Staging implements Serializable {
  ...
  /**
   * Store the mapping of file and blob like so: Hello.txt:$1d229271928d3f9e2bb0375bd6ce5db6c6d348d9
   * Staging an already-staged file overwrites the previous entry in the staging area with the new
   * contents. If a file was removed and added back, remove it from stagedForRemoval.
   */
  ...
  /**
   * To-do: Can we also stop tracking the "removed files"? If not, we might not be able to
   * instantiate a new staging obj
   */
