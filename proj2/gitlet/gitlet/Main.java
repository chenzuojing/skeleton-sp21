...
public class Main {
  ...
  /**
   * print the message if a user inputs a command that requires being in an initialized Gitlet
   * working directory (i.e., one containing a .gitlet subdirectory), but is not in such a
   * directory.
   */
  ...
  /**
   * print the message if there is already a Gitlet version-control system in the current directory.
   */
  ...
  /**
   * print the message if a user inputs a command with the wrong number or format of operands.
   *
   * @param args user's input of commands and operands
   */
